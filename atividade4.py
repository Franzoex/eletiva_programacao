...
botao_potencia.grid(column=4,row=4)
...
botao_1_por=tk.Button(janela, text="1/x",command=lambda:inserir_texto("1/x"),width=13, height=4,font=("Arial",12))
botao_1_por.grid(column=4,row=2)
