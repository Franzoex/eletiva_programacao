    ...
    def realizar_jogada(self, linha, coluna):
        if self.tabuleiro[linha][coluna] == " ":
            ...
            for quadro, _ in self.quadros:
                quadro.bind("<Button-1>") #inicialmente eu tinha que escrever em qual quadrado eu queria que fosse (por exemplo no quadrado de coordenada 0 e 1), mas pedi para que quando eu clicasse o botao 1 do mouse aquele quadrado fosse selecionado, porém esse comando não funcionou
